          ...
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li className="flex items-center md:justify-start justify-center mb-2">
                <Link href="https://www.linkedin.com/in/asim-hussain-5429252b8/" className="text-gray-600 flex items-center hover:text-lg">
              ...
              <li className="flex items-center md:justify-start justify-center mb-2">
                <Link href="#" className="text-gray-600 flex items-center hover:text-lg">
              ...
              <li className="flex items-center md:justify-start justify-center mb-2">
                <Link href="https://github.com/Asim1112" className="text-gray-600 flex items-center hover:text-lg">
      ...
      <div className="theme bg-opacity-90 text-white">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className=" text-sm text-center sm:text-left">© 2024 SPORTS WEAR —
            <Link href="#" rel="noopener noreferrer" className=" ml-1" target="_blank">@Asim1112</Link>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            ...
            <Link href={"https://github.com/Asim1112"} className="ml-3">
